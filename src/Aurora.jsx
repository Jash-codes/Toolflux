...
const Aurora = ({
  colorStops = ['#0A2472', '#00072D', '#1A43BF'],
  amplitude = 1.0,
  blend = 0.5,
  speed = 5.0,
  intensity = 1.0
  ...
  useLayoutEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        uTime: { value: 0 }, uAmplitude: { value: amplitude }, uColorStops: { value: colorStopsArray },
        uResolution: { value: [0, 0] }, uBlend: { value: blend }, uIntensity: { value: intensity }
      }
    });
    ...
    const update = (t) => {
      ...
      // FIX: Increased the time multiplier to make the animation visible
      program.uniforms.uTime.value = t * 0.0003 * speed;
