...
const categoriesData = [
  ...
  { name: 'Automation', count: 16 }, { name: 'Business Intelligence', count: 12 }, { name: 'Chat', count: 25 },
...
const CategoriesPage = ({ onNavigate }) => { // Receive onNavigate as a prop
  return (
        ...
        {categoriesData.map((category) => (
          <SpotlightCard key={category.name} spotlightColor="rgba(124, 255, 103, 0.2)">
            <div className="category-card-content">
                ...
                {/* Make this button navigate to the specific tools page */}
                <button 
